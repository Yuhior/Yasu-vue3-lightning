...
function init() {
	text.value = explain.value // 说明文字
	getPictrue(); // 从后端获取图片
	nextTick(() => {
		let {imgHeight, imgWidth, barHeight, barWidth} = resetSize(proxy)
		console.log(imgHeight, imgWidth, barHeight, barWidth)
...
function getPictrue() {
	...
	backImgBase.value = result.data.originalImageBase64
	blockBackImgBase.value = result.data.originalImageBase64
